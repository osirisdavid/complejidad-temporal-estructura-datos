...
public class ArbolBinario<T>
{
	...
	public ArbolBinario(T dato) { this.dato = dato; }
	
	public T getDatoRaiz() { return this.dato; }
	...
	public void preorden() {
		...
		public void recorridoEntreNiveles(int n,int m) {
			...
			while(cola.esVacia()){
				...
				if(this.hijoIzquierdo != null){
					this.cola.encolar(this.hijoIzquierdo.dato);
					hijoIzquierdo.recorridoEntreNiveles(n, m);
				}

				if (this.hijoDerecho != null)
				{
					this.cola.encolar(this.hijoDerecho.dato);
					hijoDerecho.recorridoEntreNiveles(n, m);
				}
			}
		}
	}